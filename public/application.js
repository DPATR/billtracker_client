...
var updateBill = function updateBill(data, currentBillID) {
  return $.ajax({ // make a request of the API
...
var deleteBill = function deleteBill(currentBillID) {
  return $.ajax({
    url: config.apiOrigin + '/bills/' + currentBillID,
    method: 'DELETE',
    headers: {
...
var initAuthElements = function initAuthElements() {
...
var initCreateElements = function initCreateElements() {
...
var onSignOut = function onSignOut(event) {
  var data = store.user.id; // new with navbutton
  $('#message').text('');
...
var onNavSignOut = function onNavSignOut(event) {
  signedIn = store.signedIn;
  if (!signedIn) {
...
var onNavChangePassword = function onNavChangePassword(event) {
  signedIn = store.signedIn;
  if (!signedIn) {
    $('#message').text('You need to be signed in to change password');
  } else {
...
var clearBills = function clearBills() {
  event.preventDefault();
  ui.clearBills();
};

var validateCreateForm = function validateCreateForm(createCreditor, createMonth, createAmount) {
  // validate all data entered in the create-bill form
  if (createCreditor === '' || createMonth === '' || createAmount === '') {
    // return false if all 3 data elements are not entered on screen
    return false;
  } else {
    if ($.isNumeric(createAmount)) {
      // return 'Not Numeric' if text or invalid characters are entered in the Amount Due field
      return true;
    } else {
      return 'Not Numeric';
    }
...
var setCreateForm = function setCreateForm() {
  signedIn = store.signedIn;
  if (!signedIn) {
...
var onCreateBill = function onCreateBill(event) {
  // const data = getFormFields(this)
  var createCreditor = $('#create-bill').find('input[name="c_creditorName"]').val();
  var createMonth = $('#create-bill').find('input[name="c_dueMonth"]').val();
  var createAmount = $('#create-bill').find('input[name="c_dueAmount"]').val();
  var validData = validateCreateForm(createCreditor, createMonth, createAmount);
  if (validData === false) {
    ...
    api.createBill(newBillData).then(ui.createBillSuccess).catch(ui.createBillFailure);
  }
};
...
var onGetBills = function onGetBills(event) {
  ...
  if (!signedIn) {
    ...
    initCreateElements();
    initVariables();
    api.getBills().then(ui.getBillsSuccess).catch(ui.getBillsFailure);
  }
};
...
var store = __webpack_require__(3);
var api = __webpack_require__(6);
var showBillsTemplate = __webpack_require__(17); // When you set a variable to a require that instantiates handlebars, the variable becomes a function.
...
var signInSuccess = function signInSuccess(data) {
  ...
  store.signedIn = true;
  api.getBills().then(getBillsSuccess).catch(getBillsFailure);
...
var createBillSuccess = function createBillSuccess(data) {
  api.getBills().then(getBillsSuccess).catch(getBillsFailure);
  $('#message').text('Create bill was successful');
  $('#create-bill').hide();
};

var createBillFailure = function createBillFailure(error) {
  console.error(error);
  $('#message').text('Error on create bill');
};

var updateBillSuccess = function updateBillSuccess(data) {
  api.getBills().then(getBillsSuccess).catch(getBillsFailure);
...
var updateBillFailure = function updateBillFailure(error) {
  console.error(error);
  $('#message').text('Error on update bill');
};

var deleteBillSuccess = function deleteBillSuccess(data) {
  api.getBills().then(getBillsSuccess).catch(getBillsFailure);
  $('#message').text('Pay Bill was successful');
};

var deleteBillFailure = function deleteBillFailure(error) {
  console.error(error);
  $('#message').text('Error on delete bill');
};

var onUpdateSave = function onUpdateSave() {
  // When signed in user enters data in the modal for edit/update bill and clicks on Save Changes button
  event.preventDefault();
  var currentBillID = store.currentBillID;
  var creditor = $('#modalForm').find('input[name="creditor"]').val();
  var billingMonth = $('#modalForm').find('input[name="billing_month"]').val();
  var amountDue = $('#modalForm').find('input[name="amount_due"]').val();
  var modalEdit = true;
  ...
  if (!modalEdit) {
    ...
    api.updateBill(updBillData, currentBillID).then(updateBillSuccess).catch(updateBillFailure);
  }
};

var getBillsSuccess = function getBillsSuccess(data) {
  // This function will use handlebars to display a list of Bills for signed in user, Delete the bill when use clicks Pay Bill button and Update the bill when user clicks Update Bill button
  $('#create-bill').hide();
  $('#content').show();
  var showBillsHtml = showBillsTemplate({ bills: data.bills }); // showBillsTemplate is a function created by requiring handlebars; takes 1 param-an object array of bills
  ...
  $('.paybill').on('click', function (event) {
    ...
    var currentBillID = $(this).data('id');
    api.deleteBill(currentBillID).then(deleteBillSuccess).catch(deleteBillFailure);
  });
  $('.updatebill').on('click', function (event) {
    // need to put this click handler here because the button needs to be loaded into the DOM before I can put a click handler on it (i.e. cannot put this event listener into memory on page load like the others)
    event.preventDefault();
    $('#updateBillModal').modal('show');
    var currentBillID = $(this).data('id'); // changed after handlebars change on button:  data-id="{{bill.id}}"
    store.currentBillID = currentBillID;
    var currentCreditor = $(this).data('billcreditor');
    var currentBillMonth = $(this).data('billmonth');
    var currentAmountDue = $(this).data('amountdue');
...
var getBillsFailure = function getBillsFailure(error) {
  console.error(error);
...
module.exports = {
  ...
  createBillSuccess: createBillSuccess,
  createBillFailure: createBillFailure,
  deleteBillSuccess: deleteBillSuccess,
  deleteBillFailure: deleteBillFailure,
  updateBillSuccess: updateBillSuccess,
  updateBillFailure: updateBillFailure,
  getBillsSuccess: getBillsSuccess,
  getBillsFailure: getBillsFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.bills : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "      <a data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"list-group-item\" id=\"item\">\n      <h3 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"list-group-item-heading\"id=\"creditor_heading\" > "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.creditor : stack1), depth0))
    + "</h3>\n      <br>\n      <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"list-group-item-text\"> Billing Month: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.billing_month : stack1), depth0))
    + "\n      <br>\n      <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"list-group-item-text\"> Amount Due: $"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.amount_due : stack1), depth0))
    + "\n      <br>\n      <br>\n      <div>\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class='paybill' name='pay'>Pay Bill</button>\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-billcreditor=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.creditor : stack1), depth0))
    + "\" data-billmonth=\""
    ...
    + "\" data-amountdue=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.amount_due : stack1), depth0))
    + "\" class='updatebill' name='update'>Edit Bill</button>\n      </div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "    <p id=\"billmsg\">You have no bills to display!</p>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<!-- Below is one block of HTML for each record in an array -->\n<!-- In api.js, the get request is url: app.host + '/bills' which returns an array of bills -->\n<!-- This code iterates through all rows in the array of bills  -->\n<div class=\"container-handler\">\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.bills : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
...
// module
exports.push([module.i, ".container-fluid {\n  background-color: #183249;\n}\n\n#create-bill{\n  display: none;\n}\n\n.buttons {\n  align-items: center;\n}\n\n.navbar.navbar-inverse {\n    border: 0;\n    -webkit-box-shadow: none;\n    box-shadow: none;\n}\n\n.btn-view, .btn-create {\n  background-color: #cec491;\n  color: #800000;\n}\n\n#nav-bar-signout, #nav-bar-chgpswd {\n  color: #cec491;\n  font-size: 20px;\n}\n\n.headingContainer {\n  align-items: center;\n  background-color: #dbd095;\n  display: flex;\n  height: 100px;\n}\n\n.headingContainer, h2 {\n  margin: auto;\n  vertical-align: middle;\n}\n\n.topHeading {\n  color: #800000;\n  font-family: Georgia, serif;\n  font-size: 50px;\n  font-style: italic;\n  font-weight: bold;\n  padding-bottom: 22px;\n  padding-top: 10px;\n  vertical-align:middle;\n}\n\n#change-password {\n  display: none;\n}\n\n#item {\n  background-color: #cec491;\n}\n\n#creditor_heading {\n  color: #183249;\n  font-family: sans-serif;\n  font-size: 28px;\n  font-style: italic;\n  font-weight: bold;\n  text-align: center;\n}\n\n.list-group-item-text {\n  font-family: sans-serif;\n  font-size: 22px;\n  font-weight: bold;\n  text-align: left;\n  color: #183249;\n}\n\n.updateBillModal {\n  background-color: #FFCB9A;\n}\n\n.modal-title, h5 {\n  font-size: 30px;\n  color: #800000;\n}\n\n#content {\n  display: none;\n  opacity: .9;\n  background-color: #183249;\n  padding-left: 25%;\n  padding-right: 25%;\n}\n\n.authlabel, .createlabel {\n  color: #cec491;\n  font-size: 20px;\n}\n\n#submit-update {\n  background-color: #dfc5ac;\n  color: #896443;\n}\n\n.authClickSignup, .authClickSignin, .authClickPswd, .btn-newbill {\n  background-color: #cec491;\n  border: 1px solid;\n  border-radius: 8px;\n  color: #800000;\n  font-size: 17px;\n}\n\n.paybill, .updatebill {\n  background-color: #183249;\n  border: 2px solid;\n  border-radius: 8px;\n  color: #dbd095;\n  font-size: 15px;\n}\n\n.signup, .signin, .pswdchange, .createBill, .updateBill {\n  background-color: #c7baaf;\n}\n\n.createBill, .pswdchange, .signup, .signin {\n  border: 1px solid #999999;\n  font-size: 15px;\n  height: 31px;\n  padding: 5px;\n  width: 152px;\n}\n\n.message {\n  color: #dd920a;\n  font-family: sans-serif;\n  font-size: 18px;\n  padding-left: 2%;\n  text-align: left;\n}\n\n#billmsg {\n  color: #e39811;\n  font-family: sans-serif;\n  font-style: italic;\n  font-size: 30px;\n  text-align: center;\n}\n", ""]);
